<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="PhilanthroPortal.loginsam" %>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="state">
            <br />
            <br />
            <asp:RadioButton ID="rbdonar" runat="server" Text="Donar" GroupName="type" AutoPostBack="True" />
            <asp:RadioButton ID="rborg" runat="server" Text="Organization" GroupName="type" AutoPostBack="True" />
            <asp:RadioButton ID="rbind" runat="server" Text="Individual" GroupName="type" AutoPostBack="True" />
        </div>
		<div class="form">
            <div class="log">
                Email
			...
			<div class="login">
                <asp:Button ID="btnlog" runat="server" Text="Login" Width="195px" BackColor=" #8bc34a" BorderStyle="None" />
			</div>
		</div>
		<div class="fack">
            <asp:LinkButton ID="lbfor" runat="server">Forgot Password</asp:LinkButton>
		</div>
        <div class="fack">New Registration?
