<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="resetpassorg.aspx.vb" Inherits="PhilanthroPortal.resetpassorg" %>
...
<asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" BackColor="#3366FF" />
    </form>
  </div>
</div>
    </form>
