<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="profileorg.aspx.vb" Inherits="PhilanthroPortal.profileorg" %>
    ...
    <div class="container">
            ...
            <div class="content">
                ...
                <div class="profile-info">
                    ...
                    <asp:Label ID="orguser" runat="server" Text=""></asp:Label>
                </div>
                
                <div class="profile-info">
                    <label class="profile-info label">Organization Name:</label>
                    <asp:Label ID="orgname" runat="server" Text=""></asp:Label>
                </div>
                    <div class="profile-info">
                    <label>Vission:</label>
                    <asp:Label ID="vis" runat="server" Text=""></asp:Label>
                </div>
                <div class="profile-info">
                ...
                <div class="profile-info">
                    <label  class="profile-info label">NGO No:</label>
                    <asp:Label ID="ngo" runat="server" Text=""></asp:Label>
                </div>
                    <div class="profile-info">
                    <label>Account No:</label>
                    <asp:Label ID="acc" runat="server" Text=""></asp:Label>
                </div>
                <div class="profile-info">
